...
author:
  - name: Marcus Ramalho, Ariel Levy e Eduardo Camilo
format:
  revealjs:
      incremental: false
      transition: slide
      ...
      theme: night
      header: XI Xornada de Usuarios de R en Galicia
      header-logo: https://www.r-users.gal/sites/default/files/logoweb_2.png
      logo: images/uff.png
...
10. Otmização de carteiras de ativos
...
- $\mu^T$: vetor de retornos esperados
- $w$: vetor de pesos dos ativos
- $\lambda$: fator de aversão ao risco
...
onde:
- $\Sigma$: matriz de covariância dos retornos dos ativos
- $w^T$: vetor transposto de pesos dos ativos
- $w$: vetor de pesos dos ativos
- $\lambda$: fator de aversão ao risco
...
## Passos para otimização de portfólios com o pacote PortfolioAnalytics

1. Criar o obejto de portfólio
2. Adicionar restrições
3. Adicionar a função objetivo
4. Resolver o problema de otimização
5. Visualizar os resultados
6. Exibir os pesos dos ativos
7. Plotar a distribuição dos pesos na carteira otimizada

## Exemplo prático - Criação do objeto de portfólio
...
-  Eduardo Camilo:
    -   [GitHub](https://github.com/eduardo-camilo)
    -   E-mail: ecamilo@id.uff.br
    -  linkedin: [Eduardo Camilo](https://www.linkedin.com/in/eduardo-camilo-da-silva-dsc-cap%C2%AE-a9801416/?originalSubdomain=br)